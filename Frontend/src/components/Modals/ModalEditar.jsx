              ...
              <div key={campo.name} className={campo.className || "col-span-2"}>
                ...
                {campo.type === "select" ? (
                  <select
                    ...
                    className="cursor-pointer w-full px-3 py-2 border  border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-700 text-white"
                    disabled={isSubmitting}
                  >
