...
export default function UsuariosCRUD() {
  ...
  // 1) Validar estado antes de abrir confirmación
        ...
        <div className="flex w-full md:w-1/2 gap-2">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="text-sm rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
            >
              {[5, 10, 25].map((n) => (
          ...
          <div className="relative w-full">
            ...
            <input
              ...
              className="pl-10 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg text-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            />
          </div>
        </div>
      </div>
