...
router.get("/", autenticarUsuario,verificarPermiso("verCuentasPorCobrar"),listaCuentasPorCobrar);
router.get("/clientes", clientesConCXC);
router.get("/totales/:cliente_id", getTotalesPorCliente);
router.get("/cuentas/:cuenta_id/saldo", verificarPermiso("registrarAbonoCliente"), getSaldoCuenta);
